...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section className="mt-12 px-4">
        <Link to="/products" className="block">
          <div className="rounded-3xl overflow-hidden relative" style={{ border:'1px solid var(--border)' }}>
            <div className="aspect-[21/9] w-full">
              <Img src="https://images.unsplash.com/photo-1503342217505-b0a15cf70489?w=2000&auto=format&fit=crop" alt="Sponsored Hero" className="w-full h-full object-cover" />
            </div>
            <div style={{ position:'absolute', left:18, bottom:18, right:18, color:'#fff' }}>
              <div className="text-[11px] uppercase tracking-wide opacity-90">Gesponsert</div>
              <h3 className="font-display" style={{ fontSize:26, letterSpacing:0.2 }}>Edition Capsule</h3>
            </div>
          </div>
        </Link>
      </section>
      ...
      <section className="mt-8">
        <div style={{ marginLeft:'calc(50% - 50vw)', marginRight:'calc(50% - 50vw)', background:'var(--card)', borderTop:'1px solid var(--border)', borderBottom:'1px solid var(--border)' }}>
          <div className="px-4 py-3 text-[11px] uppercase tracking-wide opacity-70" style={{ color:'var(--text)' }}>Gesponsert</div>
          <div className="px-4 flex gap-3 overflow-x-auto no-scrollbar pb-4">
            {[...Array(10)].map((_,i)=> (
              <Link to="/products" key={`spr-${i}`} className="shrink-0 w-[180px] pressable">
                <div className="rounded-2xl overflow-hidden border" style={{ borderColor:'var(--border)', background:'var(--card)' }}>
                  <Img src={`https://source.unsplash.com/featured/?editorial,fashion&sig=${1900+i}`} alt={`Sponsored ${i+1}`} className="w-full h-[220px] object-cover" />
                </div>
                <div className="mt-1 text-sm" style={{ color:'var(--text)' }}>Promo #{i+1}</div>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link to="/products" className="block">
            <div className="overflow-hidden rounded-2xl">
              <div className="aspect-[4/5] w-full">
                <Img src="https://images.unsplash.com/photo-1519741497674-611481863552?w=1200&auto=format&fit=crop" alt="Editorial A" className="w-full h-full object-cover" />
              </div>
            </div>
            <h4 className="mt-2 font-display text-xl" style={{ color:'var(--text)' }}>Signature Drop</h4>
          </Link>
          <Link to="/products" className="block">
            <div className="overflow-hidden rounded-2xl">
              <div className="aspect-[4/5] w-full">
                <Img src="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=1200&auto=format&fit=crop" alt="Editorial B" className="w-full h-full object-cover" />
              </div>
            </div>
            <h4 className="mt-2 font-display text-xl" style={{ color:'var(--text)' }}>Premium Edit</h4>
          </Link>
        </div>
      </section>
